...
Dowload a backend from releases and copy it into this folder\
`$ curl -L https://github.com/weaselandfox/keras-yolo2/releases/download/v0.2.0/tiny_yolo_backend.h5 --output tiny_yolo_backend.h5`
